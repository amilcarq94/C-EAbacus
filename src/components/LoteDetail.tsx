      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-5">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#E3EFE7] text-[#00603C] border border-[#00603C] border-opacity-25 rounded-lg hover:bg-[#cbe3d3] transition text-xs font-bold cursor-pointer"
            title="Generar código QR con la URL pública de la ficha técnica del lote para acceso rápido a la trazabilidad desde dispositivos móviles"
          >
